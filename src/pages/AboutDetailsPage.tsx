...
export const AboutDetailsPage: React.FC = () => (
    <div className="bg-teal-900 min-h-screen text-yellow-50">
        <AnimatedSection className="py-20">
            <div className="container mx-auto px-6">
                ...
                >
                    ...
                    <motion.p className="text-base md:text-xl" variants={itemVariants}>
                    ...
                    <motion.p className="text-base md:text-xl mt-6" variants={itemVariants}>
                    ...
                    <motion.h2 className="text-3xl md:text-4xl font-bold pt-12 mb-4" variants={itemVariants}>
                    ...
                    <motion.ul className="list-disc list-inside space-y-3 text-base md:text-xl mt-6" variants={itemVariants}>
                        <li>
                    ...
                    <motion.div className="text-center mt-12" variants={itemVariants}>
                        <Link to="/#about">
                            <Button variant="outline" className="border-cream text-cream hover:bg-teal-medium hover:text-cream hover:border-teal-medium transition-all duration-200">
                                Back to Main Page
                            </Button>
                        </Link>
                    </motion.div>
