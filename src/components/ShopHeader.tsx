...
export function ShopHeader() {
	...
	const linkStyle = ({ isActive }: { isActive: boolean }) =>
		`inline-flex items-center px-3 py-2 rounded-md text-sm font-medium hover:text-[#C2EAE7] hover:underline transition-colors ${
				...
				<div className="flex justify-between items-center h-16">
					...
					<nav className="flex items-center space-x-6">
						{isUserAdmin ? (
							...
							<button
								onClick={openCart}
								className="relative inline-flex items-center px-3 py-2 rounded-md text-sm font-medium hover:text-[#C2EAE7] hover:underline transition-colors">
