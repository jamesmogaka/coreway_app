...
export function HoverBorderGradient({
	...
	return (
		<Tag
			...
			className={cn(
				"relative flex rounded-full border content-center bg-black/20 hover:bg-black/10 transition-colors ease-linear duration-500 dark:bg-white/20 hover:dark:bg-white/10 p-px",
				containerClassName
			)}
			{...props}>
			<div
